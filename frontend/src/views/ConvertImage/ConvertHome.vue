<template>
    <div class="min-h-full flex flex-col items-center justify-center p-4">
        <div class="text-center">
            <h1 class="text-2xl md:text-3xl font-bold mb-4">{{ t('convert.convert_home.title') }}</h1>
            <p class="mb-6 text-sm md:text-base">{{ t('convert.convert_home.desc') }}</p>
        ...
        <div class="mt-6 md:mt-8">
            <img src="/convert.png" alt="convert" class="rounded shadow-lg h-40 md:h-56 max-h-[22vh] object-cover mx-2">
        </div>
    </div>
</template>

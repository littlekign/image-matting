<template>
    ...
    <div class="text-center mb-4">
      <h1 class="text-2xl md:text-3xl font-bold mb-4">{{t('ai_matting.matting_home.title')}}</h1>
      <p class="mb-6 text-sm md:text-base">{{t('ai_matting.matting_home.desc')}}</p>
    ...
    <p class="text-gray-500 mb-4 text-xs md:text-sm">
